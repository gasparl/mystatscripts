...
for(f_name in file_names){
    ...
    # # shared_names_list = as.character(ps_in_irrs_freq$value)
    # 
...
full_data_exp2 = main_cit_data


####

names(full_data_exp1)
names(full_data_exp2)
data_exp1 = full_data_exp1
data_exp2 = full_data_exp2

# cat( names(full_data_exp1), sep = "', '")

data_exp1 = data_exp1[, c('subject_id', 'condition', 'acc_rate_irrelevant_0', 'acc_rate_irrelevant_1', 'acc_rate_probe_0', 'acc_rate_probe_1', 'acc_rate_target_0', 'acc_rate_target_1', 'corr_irrelevant_0', 'corr_irrelevant_1', 'corr_probe_0', 'corr_probe_1', 'corr_target_0', 'corr_target_1', 'dur_mean_irrelevant_0', 'dur_mean_irrelevant_1', 'dur_mean_probe_0', 'dur_mean_probe_1', 'dur_mean_target_0', 'dur_mean_target_1', 'overall_acc_irrelevant', 'overall_acc_probe', 'overall_acc_target', 'rt_mean_irrelevant_0', 'rt_mean_irrelevant_1', 'rt_mean_probe_0', 'rt_mean_probe_1', 'rt_mean_target_0', 'rt_mean_target_1', 'rt_diff_odd_0', 'rt_diff_even_0', 'rt_diff_odd_1', 'rt_diff_even_1', 'vorname', 'nachname', 'rt_mean_diffs_0', 'dur_mean_diffs_0', 'acc_rate_diffs_0', 'rt_mean_diffs_1', 'dur_mean_diffs_1', 'acc_rate_diffs_1', 'main_overall_acc', 'gender', 'age')]

data_exp2 = data_exp2[, c('subject_id', 'condition', 'acc_rate_irrelevant_0', 'acc_rate_irrelevant_1', 'acc_rate_probe_0', 'acc_rate_probe_1', 'acc_rate_target_0', 'acc_rate_target_1', 'corr_irrelevant_0', 'corr_irrelevant_1', 'corr_probe_0', 'corr_probe_1', 'corr_target_0', 'corr_target_1', 'dur_mean_irrelevant_0', 'dur_mean_irrelevant_1', 'dur_mean_probe_0', 'dur_mean_probe_1', 'dur_mean_target_0', 'dur_mean_target_1', 'overall_acc_irrelevant', 'overall_acc_probe', 'overall_acc_target', 'rt_mean_irrelevant_0', 'rt_mean_irrelevant_1', 'rt_mean_probe_0', 'rt_mean_probe_1', 'rt_mean_target_0', 'rt_mean_target_1', 'rt_diff_odd_0', 'rt_diff_even_0', 'rt_diff_odd_1', 'rt_diff_even_1', 'vorname', 'nachname', 'rt_mean_diffs_0', 'dur_mean_diffs_0', 'acc_rate_diffs_0', 'rt_mean_diffs_1', 'dur_mean_diffs_1', 'acc_rate_diffs_1', 'main_overall_acc', 'gender', 'age')]

data_bothexps = rbind(data_exp1, data_exp2)

data_bothexps


full_data = data_bothexps

neatStats::t_neat(
    c(full_data$rt_mean_probe_0, full_data$rt_mean_probe_1),
    c(
