...
for (f_name in enum(file_names)) {
    ...
    if (nrow(subj_itms_base) != 162*4-16*2) {
        # just double-check
    ...
    firstprop = paste0('p_', subj_itms_base$proportion[1])
    rbind_loop(
      main_cit_merg,
      dems,
      firstcond = subj_itms_base$proportion[1],
      subj_acc_rates,
      subj_acc_rate_cats,
      subj_acc_rate_nts,
      subj_rt_mean,
...
neatStats::anova_neat(
  full_data[full_data$variety != 'verbal',],
  values = c(
    'rt_mean_diff_yes',
    'rt_mean_diff_no'
  ), between_vars = 'variety', bf_added = F
)

 neatStats::anova_neat(
  full_data[full_data$variety != 'signal',],
  values = c(
    'rt_mean_diff_yes',
    'rt_mean_diff_no'
  ), between_vars = 'variety'
)

#

t_neat(
  full_data$rt_mean_diff_yes[full_data$variety == 'mixed'],
  full_data$rt_mean_diff_no[full_data$variety == 'mixed'],
  pair = T, plots = T, bf_added = F
)

t_neat(
  full_data$rt_mean_diff[full_data$variety == 'mixed'],
  full_data$rt_mean_diff[full_data$variety == 'verbal'],
  plots = T, bf_added = T
)
t_neat(
  full_data$rt_mean_diff_yes[full_data$variety == 'mixed'],
  full_data$rt_mean_diff_yes[full_data$variety == 'verbal'],
  plots = T, bf_added = F
)
# t_neat(
#   full_data$rt_mean_diff_no[full_data$variety == 'mixed'],
#   full_data$rt_mean_diff_no[full_data$variety == 'verbal'],
#   plots = T, bf_added = T
# )
t_neat(
  full_data$rt_mean_diff[full_data$variety == 'mixed'],
  full_data$rt_mean_diff[full_data$variety == 'signal'],
...
t_neat(
  data_ntfills$rt_mean_diff_yes[data_ntfills$variety == 'mixed'],
  data_ntfills$rt_mean_diff_yes[data_ntfills$variety == 'verbal'],
  bf_added = F
)
t_neat(
  data_ntfills$rt_mean_diff_yes[data_ntfills$variety == 'mixed'],
  data_ntfills$rt_mean_diff_yes[data_ntfills$variety == 'signal'],
  bf_added = F
)
...
neatStats::plot_neat(
  ...
  values = c(
    'rt_mean_diff_yes',
    'rt_mean_diff_no'
  ), between_vars = c( "nonverbals", 'variety')
)

neatStats::anova_neat(
  full_data[full_data$variety == 'mixed',],
  values = c(
    'rt_mean_diff_yes',
    'rt_mean_diff_no'
...
sim_auc(full_data$rt_mean_diff[full_data$variety == 'mixed'])
sim_auc(full_data$rt_mean_diff[full_data$variety == 'verbal'])
sim_auc(full_data$rt_mean_diff[full_data$variety == 'signal'])
